...
// I really love pizza!
let myPizza = ["Afghani Tikka Pizza", "fajita sensation pizza", "Cheez Pizza"];
// print only name of pizza
for (let i = 0; i < myPizza.length; i++) {
    console.log(myPizza[i]);
}
// printing name and sentense/message
for (let i = 0; i < myPizza.length; i++) {
    console.log(` I like to eat ${myPizza}[i]}`);
}
console.log(`\nI really like to eat pizza. pizza comes in a variety of flavours. `);
